<?php
  ...
  $id = $_GET['id'];
  $qu = "SELECT * FROM KEMATIAN WHERE ID = '$id'";
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-sitemap"></i> Peristiwa<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Lengkapi data di bawah</h3>
                                     <?php
                                        $result = mysqli_query($connection, "SELECT * FROM KEMATIAN"); 
                                    ...
                                    <form role="form" action="<?PHP echo $_SERVER['SCRIPT_NAME'] ?>" method="POST">
                                        ...
                                        <div class="form-group input-group-sm">
                                            ...
                                            <input class="form-control" name="NAMA" maxlength="90" size="60" value="<?php echo $query_data[1]; ?>" />
                                        </div>
                                        <div class="form-group input-group-sm">
                                            <label>Tanggal Meninggal</label>
                                            <input class="form-control" name="TANGGAL" maxlength="90" size="60" value="<?php echo $query_data[2]; ?>" />
                                        </div>
                                        <div class="form-group input-group-sm">
                                            <label>Sebab</label>
                                            <input class="form-control" name="SEBAB" maxlength="90" size="60" value="<?php echo $query_data[3]; ?>" />
                                        </div>
                                        <div class="form-group input-group-sm">
                                            <label>Penentu Kematian</label>
                                            <input class="form-control" name="PENENTU" maxlength="90" size="60" value="<?php echo $query_data[4]; ?>" />
                                        </div>
                                        <div class="form-group input-group-sm">
                                            <label>Tempat Kematian</label>
                                            <input class="form-control" name="TEMPAT" maxlength="90" size="60" value="<?php echo $query_data[5]; ?>" />
                                        </div>
                                        <div align="right">
...
<?php 
  ...
  if($edit) {
    if($id == "" || $nama == "" || $tanggal == "" || $sebab == "" || $penentu == "" || $tempat == "" ){
      ?>
      <script type="text/javascript">alert("inputan tidak boleh kosong");
      </script>
      <?php
    }else {
        mysqli_query($connection, "update KEMATIAN set NAMA = '$nama', TANGGAL = '$tanggal', SEBAB = '$sebab', PENENTU = '$penentu', TEMPAT = '$tempat' where ID = '$id'") or die (mysql_error());
        ?>
