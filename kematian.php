            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="tambah_mati.php" class="btn btn-primary">Tambah Data</a>
                        <br><br>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_mati.php?id=<?php echo $query_data[0]; ?>" class="btn btn-success">Ubah</a>
                                            <a href="hapus_mati.php?id=<?php echo $query_data[0]; ?>" class="btn btn-danger" onclick="return confirm('Yakin mau di hapus?');">Hapus</a>
                                        </td>
                                    </tr>
